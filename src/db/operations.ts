...
export async function saveFocusSession() {
  ...
  // Note: Kysely .transaction() is incompatible with @tauri-apps/plugin-sql's connection
  // pool — BEGIN/ROLLBACK may land on different pool connections. Run sequentially instead.
